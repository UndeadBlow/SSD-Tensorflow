...
def ssd_net(inputs,
    ...
    with tf.variable_scope(scope, 'ssd_300_vgg', [inputs], reuse=reuse):
        ...
        net = slim.conv2d(net, 256, [3, 3], rate=6, scope='conv6')
        ...
        with tf.variable_scope(end_point):
            net = slim.conv2d(net, 64, [1, 1], scope='conv1x1')
            net = custom_layers.pad2d(net, pad=(1, 1))
            net = slim.conv2d(net, 128, [3, 3], stride=2, scope='conv3x3', padding='VALID')
        end_points[end_point] = net
        end_point = 'block9'
        with tf.variable_scope(end_point):
            net = slim.conv2d(net, 32, [1, 1], scope='conv1x1')
            net = custom_layers.pad2d(net, pad=(1, 1))
            net = slim.conv2d(net, 64, [3, 3], stride=2, scope='conv3x3', padding='VALID')
        end_points[end_point] = net
